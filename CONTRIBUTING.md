# Contributing to the Frappe ecosystem 

Thank you for taking the time to contribute!

You can start by reading our [Contribution guidelines](https://docs.frappe.finance/code/contributing) first.
...
```
TranslateString(675, `You have ${frappeBalance} left in your wallet`, { num: frappeBalance })
```
